<?php require_login(); $u=user(); $company=setting('company_name','Color Heaven'); $notificationUnread=0; try{ if(table_exists('notifications')){ $nw='is_read=0'; $np=[]; if(in_array('user_id', table_columns('notifications'), true) && !empty($u['id'])){ $nw.=' AND (user_id IS NULL OR user_id=?)'; $np[]=$u['id']; } $notificationUnread=table_count('notifications',$nw,$np); } }catch(Throwable $e){ $notificationUnread=0; } ?>
<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title><?=e($title??'ERP')?> - <?=e($company)?></title><link rel="icon" href="/assets/images/favicon.png"><link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet"><link href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.css" rel="stylesheet"><link href="/assets/css/erp.css?v=20260704" rel="stylesheet"><link href="/assets/css/erp_autocomplete_fix.css?v=20260705" rel="stylesheet"><link href="/assets/css/erp_order_collection_mobile.css?v=20260705" rel="stylesheet"><link href="/assets/css/erp_order_product_lookup_fix.css?v=20260707" rel="stylesheet"><script defer src="/assets/js/erp_responsive.js?v=20260704"></script><script defer src="/assets/js/erp_autocomplete_fix.js?v=20260705"></script><script defer src="/assets/js/erp_order_collection_mobile.js?v=20260705"></script><script defer src="/assets/js/erp_order_product_lookup_fix.js?v=20260707"></script><script defer src="/assets/js/office_inventory_statement_buttons.js?v=20260704"></script></head><body><div class="layout"><aside class="sidebar"><div class="brand"><img src="/assets/images/logo.png" alt="Color Heaven"><div><strong><?=e($company)?></strong><small><?=e(setting('company_tagline','The Empire of Color'))?></small></div></div><nav>
<?php
